...
def mock_weight_sensor():
    """
    Simulates operational weight metrics generated by a lightweight sensor stub.
    """
    if time.time() % 30 < 5:
        return 26.5
    return 12.2
...
def run_vision_pipeline(video_source="video1.mp4"):
    ...
    while cap.isOpened():
        ...
        sensor_weight = mock_weight_sensor()

        detected_incident = None
        if sensor_weight > 20.0 and final_avg_proc > 4.0:
            detected_incident = "LUGGAGE_DISPUTE"
